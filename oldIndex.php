        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="row" id="sections">
                    <?php
                    include("oldquickLinks.php");
                    ?>
                    <?php
                    include("oldwhatsNew.php");
                    ?>
                    <?php
                    include("oldcalendar.php");
                    ?>
                </div>
                <div class="row">
                    <?php

                    include("oldtwitterTimeline.php");

                    ?>
                    <?php

                    include("olddistrictLinks.php");

                    ?>
                    <?php

                    include("oldaboutUs.php");
