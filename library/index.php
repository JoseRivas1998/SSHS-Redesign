                ...
                <div class="col-xs-12 col-sm-3">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="panel-title">Digital Resources</div>
                        </div>
                        <div class="panel-body">
                            <div class="list-group">
                                ...
                                <a href="http://www.galesites.com/menu/index.php?loc=santa" class="list-group-item">Gale
                                    Databases</a>
                                <a href="http://src.scholastic.com/ecatalog/default.asp?UID=DC5CD0F78DA447E281A308DC0E06D18C&amp;subt=0&amp;Test=NA"
                                   class="list-group-item">SRC e-Catalog</a>
                                <a href="javascript:void(0)" class="list-group-item"
                                   onclick="loadFile('mobileapps.html');">Mobile Apps</a>
                                <a href="javascript:void(0)" class="list-group-item"
                                   onclick="loadFile('librarywithoutwalls.html');">Library Without Walls</a>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="panel-title">Student Resources</div>
                        </div>
                        <div class="panel-body">
                            <div class="list-group">
                                <a href="javascript:void(0)" class="list-group-item"
                                   onclick="loadFile('resources.html');">Resources</a>
                                <a href="javascript:void(0)" class="list-group-item"
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="panel-title">Important Documents</div>
                        </div>
                        <div class="panel-body">
                            <div class="list-group">
                                <a href="downloads/LibraryPracticeApplication.pdf" class="list-group-item">Library
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="list-group">
                                ...
                                <a href="javascript:void(0)" class="list-group-item"
                                   onclick="loadFile('overview.html');">Book Overview</a>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
