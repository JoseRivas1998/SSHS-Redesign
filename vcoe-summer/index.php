...
<head>
    ...
    include($path);
    ?>
    <title>VCOE Summer Career Camps AVAILABLE | Santa Susana High School</title>
    <style>
      ul {
        list-style: none;
        padding-left: 0;
...
<section id="content-wrapper">
    <div class="container" id="content-container">
        <div class="row">
            <div class="col-xs-12">
              <div class="section-title">VCOE Summer Career Camps AVAILABLE</div>
            </div>
            <div class="col-xs-12">
              <p>
              ...
              <p>
                ...
                <ul>
                  <li>Shark Tank style Business and Finance </li>
