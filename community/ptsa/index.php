		...
		<div class="container" id="content-container">
			<div class="row">
	          ...
	          <strong>Historian:</strong> Natasha Schlaffer<br><br>
						<p>
	          	We invite you to join <strong>P</strong>arent <strong>T</strong>eacher <strong>S</strong>tudent <strong>A</strong>ssociation (PTSA) to help support programs, events, and activities that the PTSA provides for the school. Membership also gives you a voice and vote.
						</p>
						<img src="img/child.png" alt="Child" class="img-responsive">
						<p>
							The mission of the California State PTA is to positively impact the lives of all children and families. The deadline for entries to be at school is October 9th.
						</p>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-6">
								<div class="panel panel-default">
									...
									<div class="panel-body"><a href="downloads/Membership_Letter_2015-16.pdf" target="_blank"><img src="img/Membership_Letter_2015-16.png" alt="Membership Application" class="img-responsive"></a></div>
								</div>
							</div>
							<div class="col-xs-12 col-sm-6">
								<div class="panel panel-default">
									...
									<div class="panel-body"><a href="downloads/No_Frills_Fundraiser_Flyer_and_label_July_2015.pdf" target="_blank"><img src="img/No_Frills_Fundraiser_Flyer_and_label_July_2015_icon.png" alt="No Frills Fundraiser" class="img-responsive"></a></div>
								</div>
							</div>
						</div>
            ...
            <ul>
                ...
                <li><strong>Volunteer Opportunities</strong></li>
						...
						<p>
            	Membership cost is only <strong>$6.00</strong> per member! All parents and family members, students, teachers and staff are encouraged to join. There is no limit to how many friends and family you bring in to support our school.
						<p>
						<p>
							 Fill out the <a href="downloads/Membership_Letter_2015-16.pdf" target="_blank">attached form</a> and return it to school with cash or checks (made out to SSHS PTSA), along with the names of every member.<br><br> Gail Sarkisian
						</p>
