        ...
        <div class="row">
            <div class="col-sm-3 col-xs-12 side-nav">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-title">Senior Project</div>
                    </div>
            ...
            <div class="col-sm-9 col-xs-12">
                ...
                <div class="col-xs-12" id="btns">
                    <button class="btn btn-default" id="approvalBtn">Senior Project Approval &amp; Contract</button>
                    <br/><br/>
                    ...
                    <div class="list-group">
                      <a href="downloads/SENIOR.PROJECT.PRESENTATION.pptx" target="_blank" class="list-group-item">Senior Project Presentation</a>
                        ...
                        <a href="http://goo.gl/a7yfNj" class="list-group-item" target="_blank">Portfolio - Resources –
                            Digital Portfolio Guide</a>
                        <a href="http://sshsseniorprojectsamplesite.weebly.com" class="list-group-item" target="_blank">Portfolio
                            - Resources - Demo Site</a>
                        <a href="http://goo.gl/forms/qr5VLLhCag" class="list-group-item" target="_blank">Portfolio -
                            Resources - Portfolio Submission Form</a>
                    </div>
                </div>
            </div>
        </div>
