...
class Google_Service_ResourceTest extends BaseTest
{
    ...
    public function setUp() {
        ...
        $this->client->expects($this->any())->method("getLogger")->will($this->returnValue($this->logger));
        $this->client->expects($this->any())->method("shouldDefer")->will($this->returnValue(true));
        $this->client->expects($this->any())->method("getHttpClient")->will($this->returnValue(new GuzzleHttp\Client()));
    ...
    public function testCallFailure() {
        ...
        $this->setExpectedException("Google_Exception", "Unknown function: test->testResource->someothermethod()");
