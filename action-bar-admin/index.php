                ...
                <div class="row" id="forms">
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <form role="form" action="javascript:void(0)" id="newForm">
                            <div class="form-group">
                                <label for="barText" class="control-label">Action Bar Text<span
                                        class="red">*</span></label>
                                <input type="text" id="barText" name="barText" class="form-control"
                                       placeholder="Action Bar Text">
                            </div>
                            <div class="form-group">
                                <label for="barLink" class="control-label">Action Bar Link</label>
                                <input type="text" id="barLink" name="barLink" class="form-control"
                                       placeholder="Action Bar Link (If Applicable)">
                            </div>
                            <div class="form-group">
                                <label for="publish" class="control-label">Publish Date (When bar will first
                                    appear)<span class="red">*</span></label>
                                <input type="datetime-local" id="publish" name="publish" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="showUntil" class="control-label">Show Until (When bar will no longer appear)<span
                                        class="red">*</span></label>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <form role="form" action="javascript:void(0)" id="editForm">
                            ...
                            <div class="form-group">
                                <label for="editText" class="control-label">Action Bar Text<span
                                        class="red">*</span></label>
                                <input type="text" id="editText" name="editText" class="form-control"
                                       placeholder="Action Bar Text">
                            </div>
                            <div class="form-group">
                                <label for="editLink" class="control-label">Action Bar Link</label>
                                <input type="text" id="editLink" name="editLink" class="form-control"
                                       placeholder="Action Bar Link (If Applicable)">
                            </div>
                            <div class="form-group">
                                <label for="editPublish" class="control-label">Publish Date (When bar will first appear)<span
                                        class="red">*</span></label>
                                <input type="datetime-local" id="editPublish" name="editPublish" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="editShowUntil" class="control-label">Show Until (When bar will no longer
                                    appear)<span class="red">*</span></label>
                                <input type="datetime-local" id="editShowUntil" name="editShowUntil"
                                       class="form-control">
                            </div>
                            <div class="form-group">
                                <input type="submit" class="btn btn-primary form-control" value="Send">
