	...
	<div class="panel panel-default">
		...
		<div class="panel-body panel-row-1" id="quick">
			<div class="list-group">
				<a href="resources/content/principalmessage.php" class="list-group-item"><i class="fa fa-newspaper-o fa-fw"></i> <span class="list-text">Principal's Message</span></a>
				<a href="resources/downloads/SSHS-School-Rules-F2015.pdf" target="_blank" class="list-group-item"><i class="fa fa-pencil fa-fw"></i> <span class="list-text">School Rules - Fall 2015</span></a>
				<a href="resources/downloads/aeries-instructions-for-parents.pdf" target="_blank" class="list-group-item"><i class="fa fa-font fa-fw"></i> <span class="list-text">Aeries info: parent setup, new year forms</span></a>
				<a href="https://awps.simivalleyusd.org/aeries.net/" class="list-group-item" target="_blank"><i class="fa fa-font fa-fw"></i> <span class="list-text">Aeries Website</span></a>
				<a href="resources/downloads/Finals 2015-2016 Schedules.pdf" target="_blank" class="list-group-item" target="_blank"><i class="fa fa-bell-o fa-fw"></i> <span class="list-text">Finals Week Schedule</span></a>
