			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-9">
					...
					<div class="row" id="staffPicRow">
						<div class="col-xs-12">
							<a href="Staff_Picture_20142015_1800px_high_1.5MG.jpg" target="_blank"><img src="Staff_Picture_20142015_225px_high.jpg" alt="Santa Susana Staff" class="img-responsive" id="staffPic"></a>
						</div>
					</div>
					<div class="col-xs-5">
