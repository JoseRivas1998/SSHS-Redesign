					...
					<div class="row" id="forms">
						...
						<div class="col-xs-12 col-sm-6">
							...
							<form role="form" action="javascript:void(0)" id="editForm">
								<div class="form-group">
									<label for="editStaffList" class="control-label">Select Support Staff Member to Edit</label>
									<select name="editStaffList" id="editStaffList" class="form-control"></select>
								</div>
								<div class="form-group">
									<label for="editFirstName" class="control-label">Fist Name<span class="red">*</span></label>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="editEmail" name="editEmail" placeholder="email@simivalleyusd.org">
								</div>
								<div class="form-group">
									<label for="editPosition" class="control-label">Position<span class="red">*</span></label>
