    ...
    <div class="container" id="content-container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <p>
                    <strong>We congratulate the Mock Trial team and Mr. Matthew Long, their adviser, on their
                        win!</strong>
                </p>
                <p>
                ...
                <div class="row" id="bottomImages">
                    <div class="col-xs-12 col-sm-6">
                        <img src="images/nikol-spaho-and-trophy.jpg" alt="Nikol Spaho and Trophy"
                             class="img-responsive">
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <img src="images/megan-jones-and-trophy.jpg" alt="Megan Jones and Trophy"
                             class="img-responsive">
                    </div>
                </div>
                <p>
