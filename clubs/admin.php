                ...
                <div class="row" id="forms">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <form role="form" action="javascript:void(0)" id="newForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="newWebsite" name="newWebsite"
                                       placeholder="Website URL (If Applicable)" value="">
                            </div>
                            <div class="form-group">
                                <label for="newPresident" class="control-label">President<span
                                        class="red">*</span></label>
                                <input type="text" class="form-control" id="newPresident" name="newPresident"
                                       placeholder="President's Full Name" value="">
                            </div>
                            <div class="form-group">
                                <label for="newAdvisor" class="control-label">Advisor<span class="red">*</span></label>
                                <input type="text" class="form-control" id="newAdvisor" name="newAdvisor"
                                       placeholder="Advisor's Last Name" value="">
                            </div>
                            <div class="form-group">
                                <label for="newTime" class="control-label">Meeting Time</label>
                                <input type="text" class="form-control" id="newTime" name="newTime"
                                       placeholder="Meeting Time (If Applicable)" value="">
                            </div>
                            <div class="form-group">
                                <label for="newRoom" class="control-label">Meeting Room</label>
                                <input type="text" class="form-control" id="newRoom" name="newRoom"
                                       placeholder="Meeting Room (If Applicable)" value="">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <form role="form" action="javascript:void(0)" id="editForm">
                            ...
                            <div class="form-group">
                                <label for="editPresident" class="control-label">President<span
                                        class="red">*</span></label>
                                <input type="text" class="form-control" id="editPresident" name="editPresident"
                                       placeholder="President's Full Name" value="">
                            </div>
                            <div class="form-group">
                                <label for="editAdvisor" class="control-label">Advisor<span class="red">*</span></label>
                                <input type="text" class="form-control" id="editAdvisor" name="editAdvisor"
                                       placeholder="Advisor's Last Name" value="">
                            </div>
                            <div class="form-group">
                                <label for="editTime" class="control-label">Meeting Time</label>
                                <input type="text" class="form-control" id="editTime" name="editTime"
                                       placeholder="Meeting Time (If Applicable)" value="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="checkbox">
                                <label><input type="checkbox" value="" id="editApproved"
                                              name="editApproved">Approved</label>
                            </div>
                            <div class="form-group">
                                <input type="submit" class="btn btn-primary form-control" value="Send">
                            </div>
